...
using Uni_LibraryManagement.Authentication;
...
namespace Uni_LibraryManagement.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
           //TOVA EEEE!!!!!!!!!!<--------------------------
            if (Authentication.AuthenticationManager.LoggedUser == null || !Authentication.AuthenticationManager.LoggedUser.IsAdmin)
            {
        ...
        public ActionResult Create([Bind(Include = "Id,Email,Password,IsAdmin")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Email,Password,IsAdmin")] User user)
        {
            if (ModelState.IsValid)
            {
